<#
    .SYNOPSIS
        Automated integration test for DSC_ExchWebServicesVirtualDirectory DSC Resource.
...
[System.String] $script:DSCResourceFriendlyName = 'ExchWebServicesVirtualDirectory'
...
if ($exchangeInstalled)
{
    ...
    Describe 'Test Setting Properties with ExchWebServicesVirtualDirectory' {
        $testParams = @{
