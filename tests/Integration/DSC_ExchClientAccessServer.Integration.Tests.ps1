<#
    .SYNOPSIS
        Automated unit integration for DSC_ExchClientAccessServer DSC Resource.
...
[System.String] $script:DSCResourceFriendlyName = 'ExchClientAccessServer'
...
if ($exchangeInstalled)
{
    ...
    Describe 'Test Setting Properties with ExchClientAccessServer' {
