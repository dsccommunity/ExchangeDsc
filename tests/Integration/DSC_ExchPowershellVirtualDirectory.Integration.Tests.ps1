<#
    .SYNOPSIS
        Automated integration test for DSC_ExchPowershellVirtualDirectory DSC Resource.
...
[System.String] $script:DSCResourceFriendlyName = 'ExchPowershellVirtualDirectory'
...
if ($exchangeInstalled)
{
    ...
    Describe 'Test Setting Properties with ExchPowershellVirtualDirectory' {
        $testParams = @{
