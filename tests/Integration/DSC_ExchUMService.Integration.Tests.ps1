<#
    .SYNOPSIS
        Automated integration test for DSC_ExchUMService DSC Resource.
...
[System.String] $script:DSCResourceFriendlyName = 'ExchUMService'
...
if ($exchangeInstalled)
{
    ...
    if ($serverVersion -in '2013', '2016')
    {
        ...
        Describe 'Test Setting Properties with ExchUMService' {
            $testParams = @{
