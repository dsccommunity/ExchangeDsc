<#
    .SYNOPSIS
        Automated integration test for DSC_ExchMapiVirtualDirectory DSC Resource.
...
[System.String] $script:DSCResourceFriendlyName = 'ExchMapiVirtualDirectory'
...
if ($exchangeInstalled)
{
    ...
    Describe 'Test Setting Properties with ExchMapiVirtualDirectory' {
        $testParams = @{
