<#
    .SYNOPSIS
        Automated integration test for DSC_ExchOabVirtualDirectory DSC Resource.
...
[System.String] $script:DSCResourceFriendlyName = 'ExchOabVirtualDirectory'
...
if ($exchangeInstalled)
{
    ...
    Describe 'Test Setting Properties with ExchOabVirtualDirectory' {
        $testParams = @{
