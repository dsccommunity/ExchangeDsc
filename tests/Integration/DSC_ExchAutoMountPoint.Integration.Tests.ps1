<#
    .SYNOPSIS
        Automated unit integration for DSC_ExchAutoMountPoint DSC Resource.
#>

#region HEADER
[System.String] $script:moduleRoot = Split-Path -Parent (Split-Path -Parent $PSScriptRoot)
[System.String] $script:DSCModuleName = 'ExchangeDsc'
[System.String] $script:DSCResourceFriendlyName = 'ExchAutoMountPoint'
...
function Remove-MountPointAndFolderSetup
{
    ...
    # partitions are also removed, which is necessary for ExchAutoMountPoint to find
    # the disk as usable.
...
{
    Write-Verbose -Message 'Testing ExchAutoMountPoint requires at least 2 available disks with no partitions configured'
    return
}
...
# Begin Testing
Describe 'Test ExchAutoMountPoint Scenarios' {
