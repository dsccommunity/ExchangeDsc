<#
    .SYNOPSIS
        Automated integration test for DSC_ExchMailboxDatabase DSC Resource.
...
[System.String] $script:DSCResourceFriendlyName = 'ExchMailboxDatabase'
...
if ($exchangeInstalled)
{
    ...
    Describe 'Test Creating a DB and Setting Properties with ExchMailboxDatabase' {
        ...
        <#
            ...
            To reproduce the issue in (https://github.com/PowerShell/ExchangeDsc/issues/193), you must run
