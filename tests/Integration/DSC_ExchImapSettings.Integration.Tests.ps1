<#
    .SYNOPSIS
        Automated integration test for DSC_ExchImapSettings DSC Resource.
...
[System.String] $script:DSCResourceFriendlyName = 'ExchImapSettings'
...
if ($exchangeInstalled)
{
    ...
    Describe 'Test Setting Properties with ExchImapSettings' {
        $testParams = @{
