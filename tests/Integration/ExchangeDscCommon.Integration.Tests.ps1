<#
    .SYNOPSIS
        Automated integration test for the ExchangeDscHelper helper module.
...
<#
    .SYNOPSIS
        Remove any existing Remote PowerShell sessions created by ExchangeDsc and
...
if ($exchangeInstalled)
{
    ...
    Describe 'ExchangeDscHelper\Compare-UnlimitedToString' -Tag 'Helper' {
        <#
            Test for issue (https://github.com/PowerShell/ExchangeDsc/issues/211)
