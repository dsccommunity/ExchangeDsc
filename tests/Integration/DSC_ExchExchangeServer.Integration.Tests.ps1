<#
    .SYNOPSIS
        Automated integration test for DSC_ExchExchangeServer DSC Resource.
...
[System.String] $script:DSCResourceFriendlyName = 'ExchExchangeServer'
...
function Test-ExchDscServerPrepped
{
    ...
    Context 'Server has had relevant properties nulled out for ExchExchangeServer tests' {
...
if ($null -ne $adModule)
{
    if ($exchangeInstalled)
    {
        ...
        Describe 'Test Setting Properties with ExchExchangeServer' {
            ...
            Test-TargetResourceFunctionality -Params $testParams `
                -ContextLabel 'Standard ExchExchangeServer tests' `
            ...
            # Re-run tests
            Test-TargetResourceFunctionality -Params $testParams `
                -ContextLabel 'Altered ExchExchangeServer tests' `
                -ExpectedGetResults $expectedGetResults
