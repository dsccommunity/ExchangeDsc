...
Import-Module -Name (Join-Path -Path $script:projectPath -ChildPath (Join-Path -Path 'tests' -ChildPath (Join-Path -Path 'TestHelpers' -ChildPath 'ExchangeDscTestHelper.psm1'))) -Global -Force
#endregion HEADER
# Begin Testing
try
{
    InModuleScope $script:subModuleName {
        ...
        Describe 'ExchangeDscHelper\Get-ExchangeInstallStatus' -Tag 'Helper' {
        ...
        Describe 'ExchangeDscHelper\Get-PreviousError' -Tag 'Helper' {
        ...
        Describe 'ExchangeDscHelper\Assert-NoNewError' -Tag 'Helper' {
        ...
        Describe 'ExchangeDscHelper\Assert-IsSupportedWithExchangeVersion' -Tag 'Helper' {
        ...
        Describe 'ExchangeDscHelper\Compare-ADObjectIdToSmtpAddressString' -Tag 'Helper' {
            <#
        ...
        Describe 'ExchangeDscHelper\Invoke-DotSourcedScript' -Tag 'Helper' {
            AfterEach {
                Assert-VerifiableMock
            }
        ...
        Describe 'ExchangeDscHelper\Remove-HelperSnapin' -Tag 'Helper' {
            BeforeAll {
        ...
        Describe 'ExchangeDscHelper\Test-ExchangePresent' -Tag 'Helper' {
            AfterEach {
                Assert-VerifiableMock
            }
        ...
        Describe 'ExchangeDscHelper\Test-ExchangeSetupComplete' -Tag 'Helper' {
            AfterEach {
                Assert-VerifiableMock
            }
        ...
        Describe 'ExchangeDscHelper\Test-ExchangeSetupPartiallyCompleted' -Tag 'Helper' {
            AfterEach {
                Assert-VerifiableMock
            }
        ...
        Describe 'ExchangeDscHelper\Set-WSManConfigStatus' -Tag 'Helper' {
        ...
        Describe 'ExchangeDscHelper\Test-UMLanguagePackInstalled' -Tag 'Helper' {
            AfterEach {
                Assert-VerifiableMock
            }
        ...
        Describe 'ExchangeDscHelper\Test-ShouldInstallUMLanguagePack' -Tag 'Helper' {
        ...
        Describe 'ExchangeDscHelper\Test-ExchangeSetupRunning' -Tag 'Helper' {
            AfterEach {
                Assert-VerifiableMock
            }
        ...
        Describe 'ExchangeDscHelper\Wait-ForProcessStart' -Tag 'Helper' {
            AfterEach {
                Assert-VerifiableMock
            }
        ...
        Describe 'ExchangeDscHelper\Wait-ForProcessStop' -Tag 'Helper' {
            AfterEach {
                Assert-VerifiableMock
            }
        ...
        Describe 'ExchangeDscHelper\Assert-ExchangeSetupArgumentsComplete' -Tag 'Helper' {
            AfterEach {
                Assert-VerifiableMock
            }
        ...
        Describe 'ExchangeDscHelper\Get-ExchangeVersionYear' -Tag 'Helper' {
            AfterEach {
                Assert-VerifiableMock
            }
        ...
        Describe 'ExchangeDscHelper\Get-ExchangeUninstallKey' -Tag 'Helper' {
            AfterEach {
                Assert-VerifiableMock
            }
        ...
        Describe 'ExchangeDscHelper\Get-DetailedInstalledVersion' -Tag 'Helper' {
            AfterEach {
                Assert-VerifiableMock
            }
        ...
        Describe 'ExchangeDscHelper\Get-SetupExeVersion' -Tag 'Helper' {
            AfterEach {
                Assert-VerifiableMock
            }
        ...
        Describe 'ExchangeDscHelper\Get-RemoteExchangeSession' -Tag 'Helper' {
        ...
        Describe 'ExchangeDscHelper\New-RemoteExchangeSession' -Tag 'Helper' {
        ...
        Describe 'ExchangeDscHelper\Import-RemoteExchangeModule' -Tag 'Helper' {
        ...
        Describe 'ExchangeDscHelper\Remove-RemoteExchangeModule' -Tag 'Helper' {
            # Override functions which have non-Mockable parameter types
        ...
        Describe 'ExchangeDscHelper\Compare-StringToString' -Tag 'Helper' {
        ...
        Describe 'ExchangeDscHelper\Compare-BoolToBool' -Tag 'Helper' {
        ...
        Describe 'ExchangeDscHelper\Compare-UnlimitedToString' -Tag 'Helper' {
            # Override functions which have non-Mockable parameter types
        ...
        Describe 'ExchangeDscHelper\Convert-StringToArray' -Tag 'Helper' {
        ...
        Describe 'ExchangeDscHelper\Convert-StringArrayToLowerCase' -Tag 'Helper' {
        ...
        Describe 'ExchangeDscHelper\Compare-ArrayContent' -Tag 'Helper' {
            $trueCaseInsensitiveCases = @(
                @{
                    Array1Param = @('aBc', '', 'deF')
                    Array1Lower = @('abc', '', 'def')
        ...
        Describe 'ExchangeDscHelper\Test-ArrayElementsInSecondArray' -Tag 'Helper' {
            $trueCaseInsensitiveCases = @(
                @{
                    Array1Param = @('aBc', '', 'deF')
                    Array1Lower = @('abc', '', 'def')
        ...
        Describe 'ExchangeDscHelper\Add-ToPSBoundParametersFromHashtable' -Tag 'Helper' {
            AfterEach {
                Assert-VerifiableMock
            }
        ...
        Describe 'ExchangeDscHelper\Remove-FromPSBoundParametersUsingHashtable' -Tag 'Helper' {
            AfterEach {
                Assert-VerifiableMock
            }
        ...
        Describe 'ExchangeDscHelper\Remove-NotApplicableParamsForVersion' -Tag 'Helper' {
            AfterEach {
                Assert-VerifiableMock
            }
            ...
            Context 'When Remove-NotApplicableParamsForVersion is called and the parameter exists in the current Exchange version' {
                It 'Should not modify the input PSBoundParameters' {
                    ...
                    Remove-NotApplicableParamsForVersion `
                        ...
                        -ParamName 'Param1' `
                        -ResourceName 'ExchangeDscHelper.tests.ps1' `
        ...
        Describe 'ExchangeDscHelper\Set-EmptyStringParamsToNull' -Tag 'Helper' {
        ...
        Describe 'ExchangeDscHelper\Write-InvalidSettingVerbose' -Tag 'Helper' {
            AfterEach {
                Assert-VerifiableMock
            }
        ...
        Describe 'ExchangeDscHelper\Write-FunctionEntry' -Tag 'Helper' {
            AfterEach {
                Assert-VerifiableMock
            }
        ...
        Describe 'ExchangeDscHelper\Test-CmdletHasParameter' -Tag 'Helper' {
            AfterEach {
                Assert-VerifiableMock
            }
        ...
        Describe 'ExchangeDscHelper\Test-ExchangeSetting' -Tag 'Helper' {
        ...
        Describe 'ExchangeDscHelper\Compare-IPAddressToString' -Tag 'Helper' {
            AfterEach {
                Assert-VerifiableMock
            }
        ...
        Describe 'ExchangeDscHelper\Compare-IPAddressesToArray' -Tag 'Helper' {
            AfterEach {
                Assert-VerifiableMock
            }
        ...
        Describe 'ExchangeDscHelper\Restart-ExistingAppPool' -Tag 'Helper' {
        ...
        Describe 'ExchangeDscHelper\Compare-PSCredential' -Tag 'Helper' {
            AfterEach {
                Assert-VerifiableMock
            }
        ...
        Describe 'ExchangeDscHelper\Start-ExchangeScheduledTask' -Tag 'Helper' {
        ...
        Describe 'ExchangeDscHelper\Test-ExtendedProtectionSPNList' -Tag 'Helper' {
        ...
        Describe 'ExchangeDscHelper\Get-StringFromHashtable' -Tag 'Helper' {
        ...
        Describe 'ExchangeDscHelper\Get-DomainDNFromFQDN' -Tag 'Helper' {
        ...
        Describe 'ExchangeDscHelper\Set-DSCMachineStatus' -Tag 'Helper' {
        ...
        Describe 'ExchangeDscHelper\Set-ADExtendedPermissions' -Tag 'Helper' {
            AfterEach {
                Assert-VerifiableMock
            }
