...
$script:DSCResourceName = 'DSC_ExchRemoteDomain'
...
try
{
    InModuleScope $script:DSCResourceName {
        ...
        Describe 'DSC_ExchRemoteDomain\Get-TargetResource' -Tag 'Get' {
            AfterEach {
        ...
        Describe 'DSC_ExchRemoteDomain\Set-TargetResource' -Tag 'Set' {
            AfterEach {
                Assert-VerifiableMock
            }
        ...
        Describe 'DSC_ExchRemoteDomain\Test-TargetResource' -Tag 'Test' {
            AfterEach {
                Assert-VerifiableMock
            }
