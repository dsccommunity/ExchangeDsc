...
$script:DSCResourceName = 'DSC_ExchAcceptedDomain'
...
try
{
    InModuleScope $script:DSCResourceName {
        ...
        Describe 'DSC_ExchAcceptedDomain\Get-TargetResource' -Tag 'Get' {
        ...
        Describe 'DSC_ExchAcceptedDomain\Set-TargetResource' -Tag 'Set' {
            BeforeAll {
                Mock -CommandName Get-RemoteExchangeSession -Verifiable
                Mock -CommandName Write-FunctionEntry -Verifiable
            }
        ...
        Describe 'DSC_ExchAcceptedDomain\Test-TargetResource' -Tag 'Test' {
            BeforeAll {
                Mock -CommandName Write-FunctionEntry -Verifiable
            }
