...
$script:DSCResourceName = 'DSC_ExchAddressList'
...
try
{
    InModuleScope $script:DSCResourceName {
        ...
        Describe 'DSC_ExchAddressList.tests\Get-TargetResource' -Tag 'Get' {
            AfterEach {
        ...
        Describe 'DSC_ExchAddressList.tests\Set-TargetResource' -Tag 'Set' {
            Mock -CommandName Write-FunctionEntry -Verifiable
            Mock -CommandName Get-RemoteExchangeSession -Verifiable
        ...
        Describe 'DSC_ExchAddressList.tests\Set-TargetResource - wrong filters' -Tag 'Set' {
        ...
        Describe 'DSC_ExchAddressList.tests\Test-TargetResource' -Tag 'Test' {
            BeforeAll {
                Mock -CommandName Write-FunctionEntry -Verifiable
            }
