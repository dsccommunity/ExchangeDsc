...
try
{
    InModuleScope $script:subModuleName {
        ...
        Describe 'ExchangeDscCalculatorHelper\Get-DBMapFromServersCsv' -Tag 'Helper' {
            AfterEach {
        ...
        Describe 'ExchangeDscCalculatorHelper\Get-DBListFromMailboxDatabasesCsv' -Tag 'Helper' {
            AfterEach {
                Assert-VerifiableMock
            }
        ...
        Describe 'ExchangeDscCalculatorHelper\Get-DBListFromMailboxDatabaseCopiesCsv' -Tag 'Helper' {
            AfterEach {
                Assert-VerifiableMock
            }
        ...
        Describe 'ExchangeDscCalculatorHelper\Update-StringContent' -Tag 'Helper' {
            AfterEach {
                Assert-VerifiableMock
            }
