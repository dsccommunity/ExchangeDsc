...
$script:DSCResourceName = 'DSC_ExchInstall'
...
try
{
    InModuleScope $script:DSCResourceName {
        ...
        Describe 'DSC_ExchInstall\Get-TargetResource' -Tag 'Get' {
        ...
        Describe 'DSC_ExchInstall\Set-TargetResource' -Tag 'Set' {
            AfterEach {
        ...
        Describe 'DSC_ExchInstall\Test-TargetResource' -Tag 'Test' {
            AfterEach {
