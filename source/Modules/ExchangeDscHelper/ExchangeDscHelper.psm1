...
function Get-RemoteExchangeSession
{
    ...
    {
        Write-Verbose -Message 'Importing the ExchangeDsc Remote PowerShell Module.'
...
<#
    ...
    .PARAMETER Path
        The path of the setup.exe which is used within the Exchnstall DSC resource.
#>
...
<#
    .SYNOPSIS
        ...
        which is used within the Exchnstall DSC Resource call.
        Will return Boolean.
