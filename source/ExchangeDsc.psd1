@{
    ...
    NestedModules     = @("Modules\ExchangeDscHelper\ExchangeDscHelper.psd1")
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            LicenseUri   = 'https://github.com/dsccommunity/ExchangeDsc/blob/main/LICENSE'

            # A URL to the main website for this project.
            ProjectUri   = 'https://github.com/dsccommunity/ExchangeDsc'
