...
function Remove-NotApplicableParamsForCurrentState
{
    ...
    Remove-NotApplicableParamsForVersion `
        ...
        -ResourceName 'ExchExchangeServer' `
    ...
    {
        Write-Warning -Message 'CustomerFeedbackEnabled is no longer a usable parameter for Set-ExchangeServer. You must use Set-OrganizationConfig -CustomerFeedbackEnabled instead. This parameter will be removed from future versions of the ExchangeDsc module.'
    }
